...
public class Element implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getId(), element.getId()) && Objects.equals(getClazz(), element.getClazz()) && getEventType() == element.getEventType();
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getClazz(), getEventType());
    }
